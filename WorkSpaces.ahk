...
; HOTKEYS
; -------
#1::switchDesktopByNumber(1) ; Win + Number
...
getSessionId()
{
    ...
    OutputDebug, Current Process Id: %ProcessId%DllCall("ProcessIdToSessionId", "UInt", ProcessId, "UInt*", SessionId)
    if ErrorLevel {
...
createVirtualDesktop()
{
    ...
    Send, #^d
    DesktopCount++
    CurrentDesktop = %DesktopCount%OutputDebug, [create] desktops: %DesktopCount% current: %CurrentDesktop%
}
;
